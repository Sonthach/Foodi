...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Foodi.MainActivity+FabAnimatorListener, Foodi", MainActivity_FabAnimatorListener.class, __md_methods);
	}
	...
	public MainActivity_FabAnimatorListener ()
	{
		...
		if (getClass () == MainActivity_FabAnimatorListener.class)
			mono.android.TypeManager.Activate ("Foodi.MainActivity+FabAnimatorListener, Foodi", "", this, new java.lang.Object[] {  });
	}
	...
	public MainActivity_FabAnimatorListener (android.view.View[] p0)
	{
		super ();
		if (getClass () == MainActivity_FabAnimatorListener.class)
			mono.android.TypeManager.Activate ("Foodi.MainActivity+FabAnimatorListener, Foodi", "Android.Views.View[], Mono.Android", this, new java.lang.Object[] { p0 });
	}
