...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Foodi.Adapter.ReviewAdapter, Foodi", ReviewAdapter.class, __md_methods);
	}


	public ReviewAdapter (java.util.List p0)
	{
		super (p0);
		if (getClass () == ReviewAdapter.class)
			mono.android.TypeManager.Activate ("Foodi.Adapter.ReviewAdapter, Foodi", "System.Collections.IList, mscorlib", this, new java.lang.Object[] { p0 });
	}
