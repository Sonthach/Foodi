...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Foodi.Adapter.ExCityAdapter, Foodi", ExCityAdapter.class, __md_methods);
	}


	public ExCityAdapter (java.util.List p0)
	{
		super (p0);
		if (getClass () == ExCityAdapter.class)
			mono.android.TypeManager.Activate ("Foodi.Adapter.ExCityAdapter, Foodi", "System.Collections.IList, mscorlib", this, new java.lang.Object[] { p0 });
	}
